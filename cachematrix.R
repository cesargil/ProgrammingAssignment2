## Overall description:
## Calculate the inverse of a matrix with the help of a cache, so when the inverse has already been
## calculated, retrieve it from cache instead of calculating it again.
